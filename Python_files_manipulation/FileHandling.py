...
country_config_csv_copy = os.path.join(str(current_path), 'Python_project_files\Output_files\CSV_files'
                                                          '\CountryConfig_copy'
                                                          '.csv')
CountryConfig_columns_copy = os.path.join(str(current_path), 'Python_project_files\Output_files\CSV_files'
                                                             '\CountryConfig_columns_copy.csv')
country_list_output = os.path.join(str(current_path), 'Python_project_files\Output_files\CSV_files\CountryList.csv')
